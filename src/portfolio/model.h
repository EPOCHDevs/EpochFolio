...
CREATE_ENUM(TurnoverDenominator,
            AGB,
            PortfolioValue
);
...
namespace epoch_folio {
    ...
    using InterestingDateRangeReturns = std::vector<std::pair<std::string, epoch_frame::Series>>;
    ...
    struct AllocationSummary {
        epoch_frame::Series maxLong{EMPTY_SERIES}, medianLong{EMPTY_SERIES}, medianShort{EMPTY_SERIES}, maxShort{EMPTY_SERIES};
    };
